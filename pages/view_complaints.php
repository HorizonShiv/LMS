                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo '<a onclick="return cnfdel();" class="btn btn-outline-danger" href="../backend/DB_delete.php?complaint_id=' . $row['complaint_id'] . '">Delete</a>'; ?></td>
                                                </tr>
                                        <?php
                                            endforeach;
                                        endif;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if (isset($_SESSION['manager']) == true) {
                                                            if ($row['status'] == 0) {
                                                                echo '<a class="badge badge-danger" href="../pages/change_status.php?complaint_id=' . $row['complaint_id'] . '&status=' . $row['status'] . '">Pending</a>';
                                                            } elseif ($row['status'] == 1) {
                                                                echo '<a class="badge badge-warning" href="../pages/change_status.php?complaint_id=' . $row['complaint_id'] . '&status=' . $row['status'] . '">In progress</a>';
                                                            } elseif ($row['status'] == 2) {
                                                                echo '<label class="badge badge-success">Compeleted</label>';
                                                            }
