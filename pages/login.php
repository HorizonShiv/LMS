...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="../images/SAL.png" />
  <style type="text/css">
    #clg {
      width: 150px;
      height: 70px;
...
<body>
  ...
  <footer class="footer">
    <div class="d-sm-flex justify-content-center justify-content-sm-between">
      <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Guided By : Akash Bhatt, Piyush Patel</span>
      <span class=" text-center text-sm-left d-block d-sm-inline-block">Developed by: Shiv Patel, Javlan Patel, Heet Patel.</span>
    </div>
    <div class="d-sm-flex justify-content-center justify-content-sm-between mt-2">
      <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2022 SAL Education. All rights reserved.</span>
    </div>
