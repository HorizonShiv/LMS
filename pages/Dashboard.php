        ...
        ?>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Complaints Category</h4>

                  <div class="row">
                    <div class="col-md-6 mb-4 stretch-card transparent">
                      <div class="card card-tale">
                        <div class="card-body">
                          <p class="mb-4">Lab Complaints</p>
                          <p class="fs-30 mb-2"><?php echo $lab_complaints; ?></p>
                          <p></p>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6 mb-4 stretch-card transparent">
                      <div class="card card-light-blue">
                        <div class="card-body">
                          <p class="mb-4">Class Complaints</p>
                          <p class="fs-30 mb-2"><?php echo $class_complaints; ?></p>
                          <p></p>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12 mb-4 stretch-card transparent">
                      <div class="card card-dark-blue">
                        <div class="card-body">
                          <p class="mb-4">Library Complaints</p>
                          <p class="fs-30 mb-2"><?php echo $library_complaints; ?></p>
                          <p></p>
                        </div>
                      </div>
                    </div>
